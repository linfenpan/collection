...
export default {
    ...
    computed: {
        style() {
            ...
            return {
                top: (isStaticMode ? 0 : this.top) + 'px',
                left: (isStaticMode ? 0 : this.left) + 'px',
                width: this.width + 'px',
        ...
        rect() {
            ...
            return {
                left: isStaticMode ? 0 : Math.round(this.left),
                top: isStaticMode ? 0 : Math.round(this.top),
